...
# will find an opcode - either 1, 2, or 99. The opcode indicates what to do;
...
# the positions of the two inputs (9 and 10), and the position of the output (3). To handle this opcode,
# you first need to get the values at the input positions: position 9 contains 30, and position 10 contains 40.
# Add these numbers together to get 70. Then, store this value at the output position; here, the output
